...
const AdminProductListPage = () => {
  ...
  const fetchProductsAndCategories = useCallback(async () => {
    try {
      ...
      const categoriesData = await getAllCategories(1, 1000); // Fetch all categories for filter dropdown
      if (!Array.isArray(categoriesData.data)) {
        // Note: getAllCategories now returns an object with 'data'
      ...
      }, [showToast, currentPage, itemsPerPage, debouncedSearchTerm, selectedCategoryId]); // Add dependencies for useCallback
  useEffect(() => {
